...
#define USB_DEVICE_CONFIG_CCID_MAX_MESSAGE_LENGTH (1100U) // == USB_DEVICE_CCID_SMART_CARD_MAX_IFSD
...
/*!
 * @brief Send the waiting time request to USB host
 *
 * The function is used to send the waiting time request to host.
 * This is a non-blocking function.
 *
 * If the interrupt IN pipe is busy, the function returns an error kStatus_USB_Error.
 * @return A USB error code or kStatus_USB_Success.
 */
extern usb_status_t USB_DeviceSendWtxRequest(void);
