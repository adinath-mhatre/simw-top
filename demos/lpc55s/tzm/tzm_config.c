 ...
 * Definitions
 ******************************************************************************/
#define CODE_FLASH_START_NS 0x00070000
#define CODE_FLASH_SIZE_NS 0x00028000
#if SSS_HAVE_SBL_NONE
#define CODE_FLASH_START_NSC 0x1003E840
#elif SSS_HAVE_SBL_SBL_LPC55S
#define CODE_FLASH_START_NSC 0x1006F840
#endif
#define CODE_FLASH_SIZE_NSC 0x200
#define DATA_RAM_START_NS 0x20020000
#define DATA_RAM_SIZE_NS 0x00013000
...
void BOARD_InitTrustZone()
{
    ...
    /* FLASH memory configuration from 0x00000000 to ZZZZZ, sector size is 32kB */
    AHB_SECURE_CTRL->SEC_CTRL_FLASH_ROM[0].SEC_CTRL_FLASH_MEM_RULE[0] = 0x33333333U;
    AHB_SECURE_CTRL->SEC_CTRL_FLASH_ROM[0].SEC_CTRL_FLASH_MEM_RULE[1] = 0x00333333U;
    ...
    AHB_SECURE_CTRL->SEC_CTRL_APB_BRIDGE[0].SEC_CTRL_APB_BRIDGE0_MEM_CTRL0 =
        AHB_SECURE_CTRL_SEC_CTRL_APB_BRIDGE0_MEM_CTRL0_SYSCON_RULE(0x3U) |
        AHB_SECURE_CTRL_SEC_CTRL_APB_BRIDGE0_MEM_CTRL0_IOCON_RULE(0x3U);
