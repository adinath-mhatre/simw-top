...
doPTMW_OpenSSL_1_1_1_ON="-DPTMW_OpenSSL=1_1_1" #Use 1.1.1 version (Only applicable on PC)

doPTMW_OpenSSL_3_0_ON="-DPTMW_OpenSSL=3_0" #Use 3.0 version (Only applicable on PC)
