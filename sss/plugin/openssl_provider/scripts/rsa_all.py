...
def main():
    ...
    for bit_len in rsa_bit_len:
        ...
        run("%s openssl_RSA.py --key_type %s --connection_data %s --disable_sha1 %s --disable_refkey_tests %s" % (python_exe, bit_len, args.connection_data, args.disable_sha1, args.disable_refkey_tests))
